...
- [Identity-based connections for Service Bus](https://learn.microsoft.com/azure/azure-functions/functions-bindings-service-bus-trigger?pivots=programming-language-java&tabs=in-process%2Cextensionv5#identity-based-connections)
